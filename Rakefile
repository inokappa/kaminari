...
file :mruby do
  ...
  sh "curl -L --fail --retry 3 --retry-delay 1 https://github.com/mruby/mruby/archive/2.0.1.tar.gz -s -o - | tar zxf -"
  FileUtils.mv("mruby-2.0.1", "mruby")
end

APP_NAME=ENV["APP_NAME"] || "kaminari"
